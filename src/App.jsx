    ...
    >
      <div className={`min-h-screen`}>
        ...
        <section className="pt-30 px-4 block aboutpagesmall">
          <div className="flex gap-2 px-4 md:px-8 lg:16 mx-auto text-right items-center mb-6 justify-end">
          ...
          {/* Personal Images Gallery */}
          <div className="pb-10 grid grid-cols-1 min-[1200px]:grid-cols-2 min-[1200px]:grid-cols-[2fr_1fr] gap-18 px-4 md:px-8 lg:16">
            {/* Personal Photo */}
            <div className="block min-[1200px]:hidden">
              <img src="/me.JPG" alt="Olivia Hu" className="" />
              <div className="z-10 text-sm md:text-md text-black bg-white/90 p-4">
                <span className="font-bold">some facts that define me</span>
                <ul className="z-10 text-sm md:text-md text-black">
                  <li>home: st louis, mo</li>
                  <li>house: port washington, ny</li>
                  <li>age: {age} years old</li>
                  <li>school: upenn!</li>
                  ...
                  <li>
                    fav saying: "every day, in every way, i am getting better
                    and better" this is a book quote from beartown by fredrik
                    backman idk if it counts but i try to live by this
                  </li>
                  <li>
                  ...
                  <li>
                    <span className="min-[1200px]:hidden">below</span>
            ...
            <div
              className={`grid grid-cols-1 min-[900px]:grid-cols-2 gap-8 mx-auto`}
            >
              {/* Food Image */}
              <div className="">
                ...
                <div className="z-10 text-black bg-white/90 p-4">
                  ...
                  <ul className="text-sm md:text-md">
                    <li>
                      favs restaurants: shiro's sushi (sea), mountain house
                      (ny), double knot (phl), dewey's (stl)
                    </li>
                    <li>
      ...
      <div className="min-h-screen">
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-16">
              {projects.map(project => (
                <div key={project.id} className="bg-white/90 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto mt-40">
            ...
            <div className="hidden lg:flex bg-white/80 p-12">
              <div className="flex">
                <div className="mr-8">
                  {creative
                    .filter((_, i) => i % 3 === 0)
            ...
            <div className="hidden md:flex lg:hidden bg-white/80 p-12">
              <div className="flex">
                <div className="mr-8">
                  {creative
                    .filter((_, i) => i % 2 === 0)
            ...
            <div className="flex md:hidden bg-white/80 p-4">
              <div className="flex">
                <div className="">
                  {creative.map(art => (
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-8">
              {experiences.map(experience => (
                <div key={experience.id} className="bg-white/90 p-8">
            ...
            <div className="space-y-8">
              {educations.map(education => (
                <div key={education.id} className="bg-white/90 p-8">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                    <div className="flex items-center gap-4">
                      <div className="h-12 flex items-center justify-center hidden sm:block">
                        <img
